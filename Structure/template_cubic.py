...
########################################################################
# Parameters you must change mainly is around "example"
# 1. atom_list & lattice_list
# 2. wyckoff position (x, y, z, wyckoff) from Wyckoff's book or Materials Project
# 3. 1st line "Structure Name" in POSCAR
########################################################################


# Parameters for atom name  and lattice parameters
atom_list = []
lattice_list = []
# example
# atom_list = ["W", "Cr"]
# lattice_list = [3.16469, 2.8839]
